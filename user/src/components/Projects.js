        ...
        <div className='projects'>
          <div className='project-div project-div-top'>
            ...
            <div className='project-info-right'>
              ...
              <p className='proj-descrip'>Designed to be educational and fun to use, this is a full-stack application based around an interactive map. The user is able to view, comment on and share all different kinds of animals!</p>
            </div>
          </div>
